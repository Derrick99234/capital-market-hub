    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Set up the system administrator account</p>
        </div>

        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-8 shadow-2xl">
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold text-white mb-2">Admin Account Details</h2>
            <div className="bg-gray-700/50 rounded-lg p-4 mb-4">
              <div className="text-sm text-gray-300 space-y-1">
                <div><strong>Email:</strong> admin@capitalmarkethub.com</div>
            ...
            <div className="space-y-4 mb-6">
              ...
              {result.credentials && (
                <div className="bg-gray-700/50 rounded-lg p-4 border border-yellow-500/20">
                  <h3 className="text-lg font-semibold text-yellow-400 mb-3">🔐 Admin Credentials</h3>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-blue-400">{result.credentials.role}</span>
                    </div>
                  </div>
                  <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded">
                    <p className="text-yellow-400 text-sm">
                      ⚠️ <strong>Important:</strong> Save these credentials securely! You won't be able to see the password again.
                    </p>
                  </div>
                </div>
              )}
